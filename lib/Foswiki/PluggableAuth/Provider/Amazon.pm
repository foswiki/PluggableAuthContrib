...
package Foswiki::PluggableAuth::Provider::Amazon;

=begin TML

---+ package Foswiki::PluggableAuth::Provider::Amazon

This is the Amazon provider based on Foswiki::PluggableAuth::Provider::OAuth.
...
sub new {
  ...
  $this->{_endpoints} = {
    ...
    user => "https://api.amazon.com/user/profile",
  };
